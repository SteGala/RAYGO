...
type MemoryProfileReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *MemoryProfileReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("memoryprofile", req.NamespacedName)
...
func (r *MemoryProfileReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&webappv1.MemoryProfile{}).
		Complete(r)
}
