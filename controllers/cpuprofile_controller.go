...
type CPUProfileReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *CPUProfileReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("cpuprofile", req.NamespacedName)
...
func (r *CPUProfileReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&webappv1.CPUProfile{}).
		Complete(r)
}
